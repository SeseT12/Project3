...
(3) If you run the runme script (or any of the Python scripts that it uses) multiple times in a short timespan, it is possible you will encounter an issue related to the ports still being occupied.
